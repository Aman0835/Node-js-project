      ...
      <StyledWrapper>
        {user && (
          <div className="card h-[780px]">
            ...
            {about && <div className="card__subtitle">{about}</div>}
            <div className="card__wrapper">
              <button className="card__btn mx-2">Ignore</button>
              <button className="card__btn card__btn-solid">Interested</button>
            </div>
          </div>
        )}
      </StyledWrapper>
